...
const AddProductScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!isConnected) {
        Alert.alert('Tidak Ada Koneksi', 'Pastikan Anda terhubung ke internet untuk menambahkan produk.');
        return;
      }
      ...
      const productId = await firebaseService.createProduct({
        name: name.trim(),
        description: description.trim(),
        price: priceNumber,
        category: category.trim(),
      ...
      const errorMessage = error instanceof Error ? error.message : 'Gagal menambahkan produk. Silakan coba lagi.';
